...
- [x] All 7 financial unit test files pass: 60 financial tests (primitives, components, goals, health, primary-goal, recommendation, summary, evaluate-client, matrix) with 0 database dependencies.
- [x] All workspaces pass quality checks on 2026-09-08:
  - `npm run test:unit`: 15 test files, 91 unit tests passed across `@meridian/api` and `@meridian/web`.
